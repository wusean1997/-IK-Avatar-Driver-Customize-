namespace TurnTheGameOn.IKAvatarDriver
{
    ...
    [CreateAssetMenu(fileName = "AvatarDriverSettings", menuName = "TurnTheGameOn/IK Avatar Driver/AvatarDriverSettings")]
    public class AvatarDriverSettings : ScriptableObject
    {
        ...
        [Range(0, 720)] public float steeringWheelRotation = 360; //maximum rotation of steering wheel transform on x axis
